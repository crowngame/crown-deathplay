...
addEventHandler("animation-system:animDURDUR", root, stopAnimation)

function stopAnimationFix2(localPlayer)
	setPedAnimation (localPlayer)
end
addEvent("stopAnimationFix2", true)
addEventHandler("stopAnimationFix2", root, stopAnimationFix2)
