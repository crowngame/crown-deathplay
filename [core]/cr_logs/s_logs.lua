...
function dbLog(logSource, actionID, affected, data)
	...
	--[[local timeString = ("%04d-%02d-%02d %02d:%02d:%02d"):format(r.year+1900, r.month + 1, r.monthday, r.hour,r.minute, r.second)
	exports.cr_mysql:lazyQuery("INSERT INTO `logtable` VALUES ('" .. timeString .. "', '" ..  exports.cr_mysql:escape_string(actionStr)  .. "', '" ..  exports.cr_mysql:escape_string(sourceStr) .. "', '" ..  exports.cr_mysql:escape_string(affectedStr) .. "', '" ..  exports.cr_mysql:escape_string(data) .. "')") -- you should have used here query_free!!!]]
	return true
end
