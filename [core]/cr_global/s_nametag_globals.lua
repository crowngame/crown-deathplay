...
function updateNametagColor(thePlayer)
	...
	elseif exports.cr_integration:isPlayerSupporter(thePlayer) and (getElementData(thePlayer, "duty_supporter") == 1) and getElementData(thePlayer, "hiddenadmin") == 0 then 
...
addEventHandler("global:toggleGoldenNametag", root, toggleGoldenNametag)