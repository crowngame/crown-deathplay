...
function loadFonts()
    fonts = {
        Roboto14 = exports.cr_fonts:getFont('sf-bold', 12),
        Roboto11 = exports.cr_fonts:getFont('sf-medium', 10),
    }
end
...
local actionTextX = panelX + iconH + respc(13)
...
Interaction.Panel = function(interactions,durum)
    if interactionActive then
        ...
        dxDrawRectangle(panelX, panelY - 100, panelW, panelH + (rowH * adjustH)+5, tocolor(25, 25, 25, 255))
        ...
        if getElementType(selectedElement) == "vehicle" then
			...
			local yil = getElementData(selectedElement, "year") or "2015"
			local araba = marka .. " " .. model .. " " .. yil 
            dxDrawText(araba, panelX, panelY - 100 + respc(13), panelW + panelX, panelH + panelY - 100, tocolor(255, 255, 255, 255), 1, fonts.Roboto14, "center", "top")
