...
function resStatRender()
	...
	if #clientRows ~= 0 then
		...
		_y = y
		dxDrawRectangle(x-10,y,150,height,tocolor(10, 10, 10, 200))
		y = y + 5
		...
		y = _y
		if #serverRows == 0 then
			dxDrawText("Client - %" .. totalCPUC,sx-74,y-19,sx-74,y-19,tocolor(0,0,0,255),1, font,"center","top",false,false,true)
			dxDrawText("Client - %" .. totalCPUC,sx-75,y-20,sx-75,y-20,tocolor(255,255,255,255),1, font,"center","top",false,false,true)
		else
			dxDrawText("Client - %" .. totalCPUC,sx-234,y-19,sx-234,y-19,tocolor(0,0,0,255),1, font,"center","top",false,false,true)
			dxDrawText("Client - %" .. totalCPUC,sx-235,y-20,sx-235,y-20,tocolor(255,255,255,255),1, font,"center","top",false,false,true)
		end
		y = newY
	end
	...
	if #serverRows ~= 0 then
		...
		local y = sy/2-height/2
		_y = y
		dxDrawRectangle(x-10,y,150,height+15,tocolor(10, 10, 10, 200))
		y = y + 5
		...
		dxDrawText("Server - %" .. totalCPUS,sx-74,y-19,sx-74,y-19,tocolor(0,0,0,255),1, font,"center","top",false,false,true)
		dxDrawText("Server - %" .. totalCPUS,sx-75,y-20,sx-75,y-20,tocolor(255,255,255,255),1, font,"center","top",false,false,true)
	end
end