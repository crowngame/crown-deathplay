function gotoPlayer(thePlayer, commandName, target)
	if exports.cr_integration:isPlayerTrialAdmin(thePlayer) or exports.cr_integration:isPlayerSupporter(thePlayer) or exports.cr_integration:isPlayerScripter(thePlayer) or exports.cr_integration:isPlayerVCTMember(thePlayer) then
		if commandName:lower() == "goto" then
			...
			if (logged == 0) then
				...
				outputChatBox("[!]#FFFFFF " .. getPlayerName(targetPlayer):gsub("_", " ") .. " isimli oyuncuya ışınladınız.", thePlayer, 0, 255, 0, true)
				outputChatBox("[!]#FFFFFF " .. exports.cr_global:getPlayerFullAdminTitle(thePlayer) .. " isimli yetkili size ışınlandı.", targetPlayer, 0, 0, 255, true)
...
function AdminLoungeTeleport(sourcePlayer)
	if (exports.cr_integration:isPlayerTrialAdmin(sourcePlayer) or exports.cr_integration:isPlayerSupporter(sourcePlayer)) then
		setElementPosition(sourcePlayer, 818.5654296875, -1347.5625, 13.525009155273)
