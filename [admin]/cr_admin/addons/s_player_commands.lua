...
addEventHandler("admin-system:adminduty", root, adminDuty)
...
addEventHandler("admin-system:gmduty", root, gmDuty)
			...
			if not (amount >= 1000000) then
				for _, player in ipairs(exports.cr_pool:getPoolElementsByType("player")) do
					if getElementData(player, "loggedin") == 1 then
						...
						exports.cr_infobox:addBox(player, "success", "Crown Deathplay'den herkese $" .. exports.cr_global:formatMoney(amount) .. " hediye!")
					end
				end
