function startRappel(x, y, z, gz)
	...
	exports.cr_pool:allocateElement(invisible)
	setTimer(stopRappel, 2000, 1, invisible, source, slot)
	exports.cr_global:applyAnimation(source, "PARACHUTE", "PARA_float", true, 1.0, false, false)
	
	for key, value in ipairs(exports.cr_global:getNearbyElements(invisible, "player", 100)) do
		triggerClientEvent(value, "createRope", value, x, y, z, gz)
	end
end
addEvent("startRappel", true)
addEventHandler("startRappel", root, startRappel)
