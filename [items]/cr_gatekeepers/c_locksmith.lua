...
-- by anumaz, for crowndeathplay, on 2014-11-09
-- configs
...
function duplicateKey(type, id)
	...
	if not exports.cr_global:hasItem(getLocalPlayer(), tonumber(keytype), tonumber(id)) then -- checks if you actually have the key on you
	...
	if not exports.cr_global:hasMoney(getLocalPlayer(), cost) then -- checks if the player has enough money to get it duplicated
