function getNearbyObjects(commandName)
	if exports.cr_integration:isPlayerAdmin1(getLocalPlayer()) then
		outputChatBox("Nearby worldobjects:", 255, 126, 0)
		local count = 0
		
		for index, nearbyObject in ipairs(exports.cr_global:getNearbyElements(getLocalPlayer(), "object")) do
