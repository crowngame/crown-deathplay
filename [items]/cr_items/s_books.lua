function startBook(id, slot)
	if not tonumber(id) then 
		outputChatBox("Error, BK#01. Report on bugs.crowndeathplay.net", client, 255, 0, 0)
		return
	end
	...
	if query then
		...
		if row then
			...
			triggerClientEvent(client, "PlayerBook", client, false, false, "Error, BK#02: Issue fetching book data! Report @ bugs.crowndeathplay.net")
		end
	else
		triggerClientEvent(client, "PlayerBook", client, false, false,"Error, BK#03: Issue Running SQL Query! Report @ bugs.crowndeathplay.net")
	end
