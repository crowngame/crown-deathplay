...
function createForumThread(fTitle, fContent)
	...
	local content = "[CENTER][IMG]http://crowndeathplay.net/wp-content/uploads/2014/01/OwlLogo4.png[/IMG]\n[SIZE=5][FONT=impact]" .. fTitle .. "[/FONT][/SIZE][/CENTER]" .. fContent
	...
	return "http://forums.crowndeathplay.net/showthread.php/" .. seccondID
end
]]